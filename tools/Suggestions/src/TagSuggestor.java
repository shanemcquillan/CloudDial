...
public class TagSuggestor {
	...
	public TopTermsList suggest(String body, String title, int amount) throws IOException {
		for(int i = 0; i < TITLE_WEIGHT; i++) {
			body+=title;
		}
		
		Document doc = new Document();
		doc.add(new Field("title", body, Field.Store.YES, Field.Index.ANALYZED, TermVector.YES));
