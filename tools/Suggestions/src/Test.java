...
public class Test {
	...
	public static void main(String[] args) {
		...
		String summary = summariser.summarise(doc, "Identifying summarisation categorisation groups content", 1);
